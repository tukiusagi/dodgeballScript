...
{
	{ "data/BGM/d5.wav", -1 },				// BGM0_-1はループ
	{ "data/BGM/ゲーム1.wav", -1 },			// BGM1
	{ "data/BGM/bgm02.wav", -1 },			// BGM2
	{ "data/BGM/tutorial.wav", -1 },		// BGM3
	{ "data/BGM/minigame.wav", -1 },		// BGM4

	{ "data/SE/system.wav", 0 },			// 決定音_0は一回だけ
	{ "data/SE/power_up0.wav", 0 },			// パワーアップ音
	{ "data/SE/sairoll1.wav", 0 },			// サイコロ転がし
	{ "data/SE/careng.wav", 0 },			// 車エンジン
	{ "data/SE/suberi.wav", 0 },			// バナナつるっ
	{ "data/SE/Dsai.wav", 0 },				// ダブルサイコロ
	{ "data/SE/miniQ.wav", 0 },				// 早押し
	{ "data/SE/miniQB.wav", 0 },			// 早押しミス
	{ "data/SE/miniC.wav", 0 },				// チキンスタート

	{ "data/SE/gameclear.wav", 0 },	

	{ "data/SE/system0.wav", 0 },			// ポーズ選択音
	{ "data/SE/system1.wav", 0 },			// ポーズ決定音
